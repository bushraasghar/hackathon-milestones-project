...
function addSkillInput() {
    var skillInputs = document.querySelectorAll('.skill-section input');
    var maxSkills = 10; // Set a maximum number of skill inputs to prevent too many
    // Check if we have less than the max allowed skill inputs
    if (skillInputs.length < maxSkills) {
        ...
        newSkillInput.required = false; // Make it optional
